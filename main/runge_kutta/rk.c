...
/* Calcola i coefficienti per il runge kutta*/
...
/*
 * funzioni tali per cui il sistema di eq. differenziali viene scritto come:
 * d/dt (x1) = f1
 * d/dt (x2) = f2
 */
...
/* Valuta l'incremento in base ai coefficienti calcolati precedentemente*/
