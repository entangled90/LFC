...
Si analizza ora la tecnica utilizzata per stimare gli errori su grandezze derivate dal correlatore:
$\langle \tilde{E_0} | \hat{x} | \tilde{E_1} \rangle $ e $ \Delta \tilde{E}$. 
