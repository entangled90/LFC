...
\begin{figure*}[!h]
  \centering
  \subfigure[Azione fredda]{\includegraphics[width=0.6\columnwidth,angle = -90]{action_cold.eps}}
  \subfigure[Azione calda]{\includegraphics[width=0.6\columnwidth,angle = -90]{action_hot.eps}}
...
\section{Analisi risultati: binning e cluster Jackknife}
...
\begin{figure*}[!h]
 ...
 \subfigure[Istogramma relativo alla varianza di $\Delta E$]{\includegraphics[width = 0.38\columnwidth,angle= -90]{energy_variance_histogram.eps}}
 \subfigure[Istogramma relativo alla varianza di $W_{01}$]{\includegraphics[width = 0.38\columnwidth,angle= -90]{matrix_variance_histogram.eps}}
...
\begin{figure*}[hp]
 ...
 \subfigure{\includegraphics[width=0.4\columnwidth]{tunnel4.png}}
  \caption{\small{Effetto tunnel contro una barrieri di potenziale larga 1.}}
  \end{figure*}
