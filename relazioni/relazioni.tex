...
\caption{\tiny{Errori per Newton-Cotes I: Logaritmo.In rosso l'errore calcolato e in verde quello stimato}}
\end{figure*}
...
\caption{\tiny{Errori per Newton-Cotes II: Logaritmo}}
\end{figure*}
...
\caption{\tiny{Errori per Newton-Cotes I: Polinomio}}
\end{figure*}
...
\caption{\tiny{Errori per Newton-Cotes II: Polinomio}}
\end{figure*}
...
Infatti l'ordine di grandezza dell'errore è sufficientemente piccolo da essere causato dalla mancanza di precisione del calcolare, già menzionata sopra.
...
di probabilità nota $g(x)$ e il più possibile simile alla funzione integranda. 
$$
...
\caption{\tiny{Confronto tra il valore dell'integrale con le diverse distribuzioni.}}
\end{figure*}
\begin{center}
...
\begin{figure*}[hb]
\centering
\includegraphics[width=0.46\columnwidth,angle=-90]{importanza_noise.eps}
\caption{\tiny{Andamento asintotico del ``rumore''.}}
\end{figure*}
...
\begin{center}
  \begin{figure*}[h]
    ...
    \caption{\tiny{Andamento dell'azione euclidea in funzione del numero di sweeps.}}
    \end{figure*}
\end{center}
...
$$
\Gamma(t) \ = \  \frac{ \sum_{i=0}^t <O(t_i)O(t_i + t)> - <O(t_i)><O(t_i)>}{\sum_{i=0}^t <{O(t_i)}^2> - <O(t_i)>^2} \ \simeq \ \exp{\left(-\frac{t}{\tau_{corr}}\right)}
$$
\begin{figure*}[ht]
\centering
  \includegraphics[width= 0.7\columnwidth,angle = -90]{gamma_t.eps}
  \caption{\tiny{Funzione di autocorellazione per ogni valore di $|l-k|$}}
  \end{figure*}
...
\begin{figure*}[h]
 ...
 \caption{\tiny{Grafico del correlatore $<x_l x_k>$}}
 \end{figure*}
...
da cui sono stati estratti il valor medio $\mu$ e la deviazione standard $\sigma$. 
%\ref{fig:fit_metropolis}.
\begin{figure*}
\centering
 \includegraphics[width=\columnwidth]{fit-energy.pdf}
 \caption{\tiny{Fit per il valore di $\Delta E$}}
 \end{figure*}
\begin{figure*}
\centering
\includegraphics[width=\columnwidth]{fit-matrix.pdf}
 \caption{\tiny{Fit per il valore di $W_{01}$}}
 \end{figure*}

 %{\tiny{Fit degli istogrammi. Le simulazioni sono state circa 4000}}
...
\begin{figure*}[!h]
  ...
  \caption{\tiny{Pendolo smorzato con forzante esterna nel caso di ciclo limite. $B = 0.5$, $Q= 0.5$ $\omega_{ext} = \tfrac{2}{3}$}}
  \end{figure*}
...
\begin{figure*}[!h]
  ...
  \caption{\tiny{Oscillatore di van der Pol. Si può notare il ciclo limite}}
  \end{figure*}
...
\caption{\tiny{Diffrazione da una doppia fenditura}}
\end{figure*}
...
la norma della funzione rimane inalterata: la norma differisce dall'unità a meno di fattori pari a $10^{-15/16}$. 
  ...
  \centering
    ...
    \caption{\tiny{Evoluzione di un pacchetto gaussiano libero, con periodicità ai bordi.}}
    \end{figure*}
\begin{figure*}[h]
 \centering
 \subfigure{\includegraphics{free_crystal.png}}
 \subfigure{\includegraphics{free5.png}}
 \caption{\tiny{Particella libera(continua)}}
 \end{figure*}
...
\begin{figure*}[hp]
 \centering
 \subfigure[Pacchetto d'onda gaussiano distante dalla buca]{\includegraphics[width=0.4\columnwidth]{scattering1.png}}
 \subfigure[Pacchetto si scontra con la buca]{\includegraphics[width=0.4\columnwidth]{scattering2.png}}
 \subfigure{\includegraphics[width=0.4\columnwidth]{scattering3.png}}
 \subfigure{\includegraphics[width=0.4\columnwidth]{scattering4.png}}
 \subfigure{\includegraphics[width=0.4\columnwidth]{scattering5.png}}
 \caption{\tiny{Scattering di un pacchetto gaussiano monocromatico con un muro di potenziale sferico.}}
 \end{figure*}
...
\begin{figure*}[h]
 \centering
 \subfigure{\includegraphics[width=0.4\columnwidth]{scattering_buca1.png}}
 \subfigure{\includegraphics[width=0.4\columnwidth]{scattering_buca2.png}}
 \subfigure{\includegraphics[width=0.4\columnwidth]{scattering_buca3.png}}
 \subfigure{\includegraphics[width=0.4\columnwidth]{scattering_buca4.png}}
 \caption{\tiny{Scattering di un pacchetto gaussiano monocromatico con una buca di potenziale sferico.}}
 \end{figure*}
\begin{figure*}
\centering
 \subfigure{\includegraphics[width=0.4\columnwidth]{scattering_buca5.png}}
 \subfigure{\includegraphics[width=0.4\columnwidth]{scattering_buca6.png}}
 \caption{\tiny{Scattering di un pacchetto gaussiano monocromatico con una buca di potenziale sferico.}}
 \end{figure*}
...
\begin{figure*}[hp]
 \centering
 \subfigure{\includegraphics[width=0.4\columnwidth]{notunnel1.png}}
 \subfigure{\includegraphics[width=0.4\columnwidth]{notunnel2.png}}
 \subfigure{\includegraphics[width=0.4\columnwidth]{notunnel3.png}}
 \subfigure{\includegraphics[width=0.4\columnwidth]{notunnel4.png}}
 \subfigure{\includegraphics[width=0.4\columnwidth]{notunnel5.png}}
 \caption{\tiny{Effetto tunnel contro una barrieri di potenziale larga 20.}}
 \end{figure*}
...
\begin{figure*}[hp]
 \centering
 \subfigure{\includegraphics[width=0.4\columnwidth]{tunnel1.png}}
 \subfigure{\includegraphics[width=0.4\columnwidth]{tunnel3.png}}
 \subfigure{\includegraphics[width=0.4\columnwidth]{tunnel2.png}}
 \subfigure{\includegraphics[width=0.4\columnwidth]{tunnel4.png}}
  \caption{\tiny{Effetto tunnel contro una barrieri di potenziale larga 1.}}
  \end{figure*}
...
\begin{figure*}[hp]
 \centering
 \subfigure{\includegraphics[width=0.4\columnwidth]{fenditura1.png}}
 \subfigure{\includegraphics[width=0.4\columnwidth]{fenditura2.png}}
 \subfigure{\includegraphics[width=0.4\columnwidth]{fenditura3.png}}
 \subfigure{\includegraphics[width=0.4\columnwidth]{fenditura4.png}}
...
$$
 ...
 \begin{figure*}[hbp]
  \centering
  \subfigure{\includegraphics[width=0.4\columnwidth]{heat1.png}}
  \subfigure{\includegraphics[width=0.4\columnwidth]{heat2.png}}
  \caption{\tiny{Evoluzione della distribuzione della temperatura nel tempo}}
 \end{figure*}
 \end{document}