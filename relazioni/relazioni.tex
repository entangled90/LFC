...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\columnwidth,angle=-90]{importanza_integrale.eps}
...
\begin{figure}[h]
 ...
 \caption{Grafico del correlatore $<x_l x_k>$}
\end{figure}
...
\centering
 ...
 \caption{Fit per il valore di $\Delta E$}
\end{figure}
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{fit-matrix.pdf}
 \caption{Fit per il valore di $W_{01}$} \caption{Fit degli istogrammi. Le simulazioni sono state circa 4000}
\end{figure}
...
\chapter{Equazione di Schr\"{o}dinger}
\begin{figure}[H]
\centering
...
\begin{figure}[h]
 ...
 \caption{Particella libera(continua)}
\end{figure}
...
$$
 ...
 \begin{figure}[H]
  ...
  \caption{Evoluzione della distribuzione del calore nel tempo}
 \end{figure}
